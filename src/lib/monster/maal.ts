...
export const MAAL: MaalDef[] = [
  ...
  { id: 'ryggbredde', navn: 'Ryggbredde', engelsk: 'across back', bokstav: 'E', kilde: 'maalt', gjelder: 'begge',
    slik: 'Voksen: 15 cm ned fra nakkeknokkelen, fra ermegap til ermegap. Barn: tilsvarende, proporsjonalt lavere.' },
  { id: 'brystbredde', navn: 'Brystbredde foran', engelsk: 'chest (across front)', kilde: 'maalt', gjelder: 'voksen',
    slik: '7 cm ned fra halspunktet foran, fra ermegap til ermegap.' },
  ...
  { id: 'ermegapDybde', navn: 'Ermegapdybde', engelsk: 'scye depth / armscye depth', bokstav: 'K–L', kilde: 'tabell', gjelder: 'begge',
    slik: 'Aldrich oppgir dette som tabellmål. Kan måles: fra nakkeknokkelen rett ned til armhulenivå.' },
  { id: 'ermegapOmkrets', navn: 'Ermegapomkrets', engelsk: 'armscye girth', kilde: 'maalt', gjelder: 'begge',
  ...
  // ---------- UNDERKROPP ----------
  { id: 'skrittdybde', navn: 'Skrittdybde (sittende)', engelsk: 'body rise', bokstav: 'Q–R', kilde: 'maalt', gjelder: 'begge',
  ...
  { id: 'skjoertelengde', navn: 'Skjørtlengde', engelsk: 'skirt length', kilde: 'valgt', gjelder: 'begge',
  ...
  { id: 'hoeyde', navn: 'Kroppshøyde', engelsk: 'height', bokstav: 'A', kilde: 'maalt', gjelder: 'barn',
    slik: 'Barnet barbeint mot vegg. Styrer hvilke konstanter blokkene bruker.' },
  { id: 'nakkehoeyde', navn: 'Nakkehøyde', engelsk: 'cervical height', bokstav: 'K–O', kilde: 'maalt', gjelder: 'barn',
